...
(function () {
  ...
  var I18N_OPTIONAL_FRAGMENTS = {
    ...
    pt: ["services-tours", "services-hourly", "services-events", "brand-collaborations", "consent", "in-motion", "in-motion-scroll-cinema", "contact-success", "mobile-booking-entry", "direct-transfer-mobile-booking-flow", "airport-mobile-booking-flow", "airport-mobile-contact-step"],
    it: ["services-tours", "services-hourly", "services-events", "brand-collaborations", "consent", "in-motion", "in-motion-scroll-cinema", "contact-success", "mobile-booking-entry", "direct-transfer-mobile-booking-flow", "airport-mobile-booking-flow", "airport-mobile-contact-step"],
    de: ["services-tours", "services-hourly", "services-events", "brand-collaborations", "consent", "in-motion", "in-motion-scroll-cinema", "contact-success", "mobile-booking-entry", "direct-transfer-mobile-booking-flow", "airport-mobile-booking-flow", "airport-mobile-contact-step"],
    ko: ["services-tours", "services-hourly", "services-events", "brand-collaborations", "consent", "in-motion", "in-motion-scroll-cinema", "contact-success", "mobile-booking-entry", "direct-transfer-mobile-booking-flow", "airport-mobile-booking-flow", "airport-mobile-contact-step"],
    "zh-hans": ["services-tours", "services-hourly", "services-events", "brand-collaborations", "consent", "in-motion", "in-motion-scroll-cinema", "contact-success", "mobile-booking-entry", "direct-transfer-mobile-booking-flow", "airport-mobile-booking-flow", "airport-mobile-contact-step"]
  };
