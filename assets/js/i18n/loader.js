...
(function () {
  ...
  var I18N_OPTIONAL_FRAGMENTS = {
    es: ["services-tours", "services-hourly", "services-events", "brand-collaborations", "consent", "in-motion", "contact-success", "mobile-booking-entry", "direct-transfer-mobile-booking-flow", "airport-mobile-booking-flow", "airport-mobile-contact-step"],
    en: ["services-tours", "services-hourly", "services-events", "brand-collaborations", "consent", "in-motion", "contact-success", "mobile-booking-entry", "direct-transfer-mobile-booking-flow", "airport-mobile-booking-flow", "airport-mobile-contact-step"],
    ru: ["services-tours", "services-hourly", "services-events", "brand-collaborations", "consent", "in-motion", "contact-success", "mobile-booking-entry", "direct-transfer-mobile-booking-flow", "airport-mobile-booking-flow", "airport-mobile-contact-step"],
    fr: ["services-tours", "services-hourly", "services-events", "brand-collaborations", "consent", "in-motion", "contact-success", "mobile-booking-entry", "direct-transfer-mobile-booking-flow", "airport-mobile-booking-flow", "airport-mobile-contact-step"],
    pt: ["services-tours", "services-hourly", "services-events", "brand-collaborations", "consent", "in-motion", "contact-success", "mobile-booking-entry", "direct-transfer-mobile-booking-flow", "airport-mobile-booking-flow", "airport-mobile-contact-step"],
    it: ["services-tours", "services-hourly", "services-events", "brand-collaborations", "consent", "in-motion", "contact-success", "mobile-booking-entry", "direct-transfer-mobile-booking-flow", "airport-mobile-booking-flow", "airport-mobile-contact-step"],
    de: ["services-tours", "services-hourly", "services-events", "brand-collaborations", "consent", "in-motion", "contact-success", "mobile-booking-entry", "direct-transfer-mobile-booking-flow", "airport-mobile-booking-flow", "airport-mobile-contact-step"],
    ko: ["services-tours", "services-hourly", "services-events", "brand-collaborations", "consent", "in-motion", "contact-success", "mobile-booking-entry", "direct-transfer-mobile-booking-flow", "airport-mobile-booking-flow", "airport-mobile-contact-step"],
    "zh-hans": ["services-tours", "services-hourly", "services-events", "brand-collaborations", "consent", "in-motion", "contact-success", "mobile-booking-entry", "direct-transfer-mobile-booking-flow", "airport-mobile-booking-flow", "airport-mobile-contact-step"]
  };
