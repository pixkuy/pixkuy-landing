...
(function initEventsMobileConfigStep(window, document) {
  ...
  function joinFareMissingLabels(labels) {
    ...
    const separator = getI18nValue("services.cards.events.mobileFarePending.separator", ",");
    const finalSeparator = getI18nValue("services.cards.events.mobileFarePending.finalSeparator", "y");
